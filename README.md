...
By default the smoke test installs `@attebury/topogram@0.2.41`. Override it with:

```bash
TOPOGRAM_CLI_PACKAGE_SPEC=/path/to/attebury-topogram-0.2.41.tgz npm run pack:check
```
