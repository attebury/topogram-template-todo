...
By default the smoke test installs `@attebury/topogram@0.2.15`. Override it with:

```bash
TOPOGRAM_CLI_PACKAGE_SPEC=/path/to/attebury-topogram-0.2.15.tgz npm run pack:check
```
